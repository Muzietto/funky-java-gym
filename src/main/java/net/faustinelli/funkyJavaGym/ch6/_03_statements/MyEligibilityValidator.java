...
import net.faustinelli.funkyJavaGym.ch6._01_naiveOptional.Optionall;
 ...
 */
public class MyEligibilityValidator {
    private EligibilityValidator validator = new EligibilityValidator();
