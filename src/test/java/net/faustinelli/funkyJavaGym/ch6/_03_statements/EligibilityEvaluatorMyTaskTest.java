 ...
 */
public class EligibilityEvaluatorMyTaskTest {

    MyEligibilityValidator validator = new MyEligibilityValidator();
    ...
    public void nonSingaporeDepotsAreInEligible() throws Exception {
        MyTask sgTask = MyTask.newBuilder().depot("OTHER_DEPOT").build();
    ...
    public void tasksWhereSourceSystemIsTBEAreEligible() throws Exception {
        MyTask sgTask = MyTask.newBuilder().triggerId("BOOKING_ENGINE").build();
    ...
    public void tasksWhereSourceSystemIsCosmicBridgeAreEligible_1() throws Exception {
        MyTask sgTask = MyTask.newBuilder().triggerId("FORWARD_BRIDGE").build();
    ...
    public void tasksWhereSourceSystemIsCosmicBridgeAreEligible_2() throws Exception {
        MyTask sgTask = MyTask.newBuilder().triggerId("BACKWARD_BRIDGE").build();
    ...
    public void tasksWhereSourceSystemIsNotCosmicBridgeAreIneligible() throws Exception {
        MyTask sgTask = MyTask.newBuilder().triggerId("THIRD_BRIDGE").build();
    ...
    public void tasksWhereSourceSystemIsNotTBEAndDepotIsNonSingaporeAreIneligible() throws Exception {
        MyTask sgTask = MyTask.newBuilder().depot("OTHER_DEPOT").triggerId("OTHER_SYSTEM").build();
